...
main (int argc, char *argv[])
{
    ...
    make_thread_table_entry (CTD_THREAD, "CTD_THREAD", nio_thread, (void *)GPS_THREAD, NULL_EXTRA_ARG_VALUE, NULL_EXTRA_ARG_VALUE, NULL_EXTRA_ARG_VALUE, NULL_EXTRA_ARG_VALUE);
    make_thread_table_entry (FATHOMETER_THREAD, "FATHOMETER_THREAD", nio_thread, (void *)GPS_THREAD, NULL_EXTRA_ARG_VALUE, NULL_EXTRA_ARG_VALUE, NULL_EXTRA_ARG_VALUE, NULL_EXTRA_ARG_VALUE);
    ...
    make_thread_table_entry (ALTIMETER_THREAD, "ALTIMETER_THREAD", nio_thread, (void *)GPS_THREAD, NULL_EXTRA_ARG_VALUE, NULL_EXTRA_ARG_VALUE, NULL_EXTRA_ARG_VALUE, NULL_EXTRA_ARG_VALUE);
